-- Ajouter 'ice_skating' aux contraintes CHECK sur sport_type dans toutes les tables concernées
...
ALTER TABLE public.workouts
  ...
  CHECK (sport_type IN ('course', 'musculation', 'natation', 'velo', 'nordic_ski', 'backcountry_ski', 'ice_skating'));
